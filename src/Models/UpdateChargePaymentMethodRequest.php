...
class UpdateChargePaymentMethodRequest implements JsonSerializable
{
     ...
     * @required
     * @maps credit_card
     * @var \BspagApiLib\Models\CreateCreditCardPaymentRequest $creditCard public property
     */
    public $creditCard;
     ...
     * @required
     * @maps debit_card
     * @var \BspagApiLib\Models\CreateDebitCardPaymentRequest $debitCard public property
     */
    public $debitCard;
     ...
     * Boleto data
     * @required
     * @var \BspagApiLib\Models\CreateBoletoPaymentRequest $boleto public property
     */
    public $boleto;
     ...
     * Voucher data
     * @required
     * @var \BspagApiLib\Models\CreateVoucherPaymentRequest $voucher public property
     */
    public $voucher;
     ...
     * Cash data
     * @required
     * @var \BspagApiLib\Models\CreateCashPaymentRequest $cash public property
     */
    public $cash;
     ...
     * @required
     * @maps bank_transfer
     * @var \BspagApiLib\Models\CreateBankTransferPaymentRequest $bankTransfer public property
     */
    public $bankTransfer;
