...
class CreateEmvDataDecryptRequest implements JsonSerializable
{
    ...
    /**
     * Dukpt data request
     * @var \BetaPayApiLib\Models\CreateEmvDataDukptDecryptRequest|null $dukpt public property
     */
    public $dukpt;
     ...
     * Encrypted tags list
     * @required
     * @var \BetaPayApiLib\Models\CreateEmvDataTlvDecryptRequest[] $tags public property
     */
    public $tags;
