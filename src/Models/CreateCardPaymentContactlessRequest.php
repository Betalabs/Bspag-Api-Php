...
class CreateCardPaymentContactlessRequest implements JsonSerializable
{
     ...
     * @maps apple_pay
     * @var \BspagApiLib\Models\CreateApplePayRequest|null $applePay public property
     */
    public $applePay;
     ...
     * @maps google_pay
     * @var \BspagApiLib\Models\CreateGooglePayRequest|null $googlePay public property
     */
    public $googlePay;

    /**
     * The Emv encrypted request
     * @var \BspagApiLib\Models\CreateEmvDecryptRequest|null $emv public property
     */
    public $emv;
