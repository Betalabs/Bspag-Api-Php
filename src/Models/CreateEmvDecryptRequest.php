...
class CreateEmvDecryptRequest implements JsonSerializable
{
     ...
     * @todo Write general description for this property
     * @required
     * @var \BetaPayApiLib\Models\CreateEmvDataDecryptRequest $data public property
     */
    public $data;

    /**
     * @todo Write general description for this property
     * @var \BetaPayApiLib\Models\CreateCardPaymentContactlessPOIRequest|null $poi public property
     */
    public $poi;
