...
class CreateEmvDataDecryptRequest implements JsonSerializable
{
    ...
    /**
     * Dukpt data request
     * @var \BspagApiLib\Models\CreateEmvDataDukptDecryptRequest|null $dukpt public property
     */
    public $dukpt;
     ...
     * Encrypted tags list
     * @required
     * @var \BspagApiLib\Models\CreateEmvDataTlvDecryptRequest[] $tags public property
     */
    public $tags;
